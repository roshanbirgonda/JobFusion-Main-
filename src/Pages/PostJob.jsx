...
const PostJob = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const selectedSkills = selectedOption.map((option) => option.value);

    // Assigning the array of skill values to the data.skills field
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 py-10">
          ...
          <div className="create-job-flex">
            <div className="lg:w-1/2 w-full">
              ...
              <input
                type="url"
                placeholder="Paste your company logo URL: https://wyimage.com/img1"
